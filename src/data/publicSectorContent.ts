...
export const audiences = [
  ...
  { title: "Emergency Response Initiatives", description: "Rapid mobilization for time-critical efforts." },
  { title: "Public-Sector Prime Contractors", description: "Subcontracting and teaming on government work." },
  { title: "Cooperative Purchasing Participants", description: "Agencies and partners using cooperative vehicles." },
];
